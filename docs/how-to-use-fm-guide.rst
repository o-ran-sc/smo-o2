...
.. [1]  ETSI NFV-SOL CNF Auto Healing with Prometheus via FM Interfaces
        https://docs.openstack.org/tacker/zed/user/etsi_cnf_auto_healing_fm.html

.. [2]  ORAN-SC Wiki
        https://wiki.o-ransc.org/download/attachments/35881444/SMO%20Functions%20v4.docx?api=v2

.. [3]  Tacker API Document for Receiving Notification
        https://docs.openstack.org/api-ref/nfv-orchestration/v2/vnflcm.html#create-a-new-subscription-v2

.. [4]  Tacker API Document for Heal Request
