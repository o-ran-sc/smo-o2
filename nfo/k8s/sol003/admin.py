...
class NfDeploymentInstanceAdmin(admin.ModelAdmin):
    list_display = ('instance_id','instantiation_state','deployment_namespace','created_at','updated_at')
    list_filter = ('instantiation_state',)
    search_fields = ('instance_id','instantiation_state',)
    #pass
