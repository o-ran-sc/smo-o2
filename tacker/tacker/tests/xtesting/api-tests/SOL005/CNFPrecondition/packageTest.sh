...
#update api-tests code from ESTI NFV-TST
sed -i 's/    Check Individual VNF LCM operation occurrence operationState is    STARTING/\n\*\*\* comment \*\*\*/g' api-tests/SOL003/VNFLifecycleManagement-API/InstantiateVNFTask.robot
sed -i 's/    Check Individual VNF LCM operation occurrence operationState is    STARTING/\n\*\*\* comment \*\*\*/g' api-tests/SOL003/VNFLifecycleManagement-API/HealVNFTask.robot
sed -i 's/vnfdId=${Descriptor_ID}/vnfdId=${vnfdId}/g' api-tests/SOL003/VNFLifecycleManagement-API/VnfLcmMntOperationKeywords.robot
