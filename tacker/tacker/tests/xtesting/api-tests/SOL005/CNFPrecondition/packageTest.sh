...
#comment out unnecessary test cases in api-tests
sed -i 's/    Check Individual VNF LCM operation occurrence operationState is    STARTING/\#Temporarily commented out\n\#   Check Individual VNF LCM operation occurrence operationState is    STARTING\n\n\*\*\* comment \*\*\*/g' ../../SOL003/VNFLifecycleManagement-API/InstantiateVNFTask.robot
