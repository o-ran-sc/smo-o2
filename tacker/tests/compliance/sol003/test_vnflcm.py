...
class BaseCNFLifecycleManagementTest(base.BaseComplSolTest):
    @classmethod
    def setUpClass(cls):
        cls.api = 'VNFLifecycleManagement-API'
        ...
        cls.vnfpkginfos = cls._create_and_upload_kubernetes_vnf_packages(['vnflcm1'])
...
class IndividualCnfLcmOperationOccurenceTest(BaseCNFLifecycleManagementTest):
    @classmethod
    def setUpClass(cls):
        cls.resource = 'IndividualVnfLcmOperationOccurence'
