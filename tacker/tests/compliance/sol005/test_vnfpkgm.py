...
class IndividualCNFPackageTest(BaseVNFPackageManagementTest):
    @classmethod
    def setUpClass(cls):
        cls.resource = 'IndividualVNFPackage'
    ...
    def test_get_individual_kubernetes_vnf_package(self):

        # Pre-conditions: One or more VNF packages are onboarded in the NFVO.
        vnfpkginfos = self._create_and_upload_kubernetes_vnf_packages(['vnflcm1'])
        variables = ['vnfPackageId:' + vnfpkginfos[0].vnfpkgid]
